                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post"
                                action="{{ route('admin.students.fees.transactions', ['student' => $student, 'fee' => $fee]) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="" id="Client"
                                                value="{{ $total_amount->amount }}" disabled>
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="client" style="padding-bottom: 10px;">Amount Left To be
                                                Paid</label>
                                            <input type="number" class="form-control" placeholder="" id="Client"
                                                value="{{ $remaining_amount }}" name="remaining_amount" readonly>
                                        </div>
                                    </div>
